...
Argon2 CPU & Nvidia GPU miner for TurtleCoin®

## Downloading and Installing for Windows, Linux, Mac, or ARM

violetminer can be downloaded from here:

* [violetminer miner](https://github.com/turtlecoin/violetminer/releases)

![violetminer-mining](../../assets/violetminer-mining.png)

## violetminer Setup and Configuration

* If on Windows, unzip the file into a new folder. There should be an executable, violetminer.exe, in this folder.
