...
To view a list of them, their interface and a brief description, as a well as guides on how to use them, you can check [this guide](wallets/Making-a-Wallet).
...
To view an in-depth guide on how to mine TurtleCoin, you can view [this guide](mining/Mining)
