...
* [Open an Existing Wallet](Using-Kryptokrona-Wallet.md#Opening-a-Wallet)
* [Create a New Wallet](Using-Kryptokrona-Wallet.md#Creating-a-Wallet)
* [Import from Keys or Seed](Using-Kryptokrona-Wallet.md#Restoring-your-Wallet-from-Seed-or-Keys)
...
4. Enter the payment ID if the recipient has provided one, or if you require one for your own purposes. Check the [payment ID section](Using-Kryptokrona-Wallet.md#payment-ids-and-how-to-use-them) if you're not sure how/when to use it.
5. Click on `Send`
